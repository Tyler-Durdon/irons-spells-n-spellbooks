...
public class StoneLanceRenderer extends EntityRenderer<Projectile> {
    ...
    private static ResourceLocation TEXTURE = IronsSpellbooks.id("textures/entity/firebolt.png");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // Make the stone lance larger and longer than firebolt
        partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -1.5F, -6.0F, 3.0F, 3.0F, 12.0F), PartPose.ZERO);
    ...
    public void render(Projectile entity, float yaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int light) {
        ...
        // Scale up the model to make it bigger
